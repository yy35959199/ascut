...
if TYPE_CHECKING:
    ...
    from autosmartcut.input_resolver import ResolvedInput
...
class SessionController:
    ...
    def setup(self, params: "PipelineParams") -> None:
        ...
        Raises:
            ...
            ValueError: 参数校验失败。
        """
        from autosmartcut.session_factory import build_session
...
class AppController(SessionController):
    ...
    def open(self, path: Path) -> "ResolvedInput":
        ...
        Raises:
            ...
            ValueError: 路径类型无法识别。
        """
        from autosmartcut.input_resolver import InputType
    ...
    def reconfigure(self) -> "ProgressReport":
        ...
        from autosmartcut.manifest_progress import infer_progress
    ...
    def _resolve_input(self, path: Path) -> "ResolvedInput":
        """仅输入解析（resolve_input）。"""
        from autosmartcut.input_resolver import resolve_input
