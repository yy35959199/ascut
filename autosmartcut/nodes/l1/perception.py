...
from autosmartcut.manifest.manifest_io import load_manifest, save_manifest, touch_layer_status
...
def run_l1_chunked(
	...
	*,
	...
	from autosmartcut.cli.progress_utils import SpeedEstimator
	from autosmartcut.nodes.l1.vad_silence import plan_chunks as vad_plan_chunks
	from autosmartcut.nodes.l1.vad_silence import silero_speech_segments
...
def plan_chunks(
	...
	*,
	...
	from autosmartcut.nodes.l1.vad_silence import plan_chunks as _plan_chunks
	return _plan_chunks(
		speech_segments,
		total_duration,
		first_chunk_min_sec=first_chunk_min_sec,
