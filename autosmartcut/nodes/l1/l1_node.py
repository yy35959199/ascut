...
from autosmartcut.manifest.manifest_io import load_manifest, save_manifest
from autosmartcut.pipeline.pipeline_events import ProgressEvent
from autosmartcut.pipeline.pipeline_models import L1Output, StageResult, StageStatus
...
class L1Node:
    ...
    async def run(self, ctx: "StageContext") -> StageResult:
        from autosmartcut.nodes.l1.perception import run_l1_chunked
